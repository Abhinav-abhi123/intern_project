...
mixin _$CharacterStore on _CharacterStore, Store {
  ...
  late final _$characterAtom = Atom(
    name: '_CharacterStore.character',
    context: context,
  );
  ...
  late final _$fetchCharacterAsyncAction = AsyncAction(
    '_CharacterStore.fetchCharacter',
    context: context,
  );

  @override
  Future<void> fetchCharacter(String id) {
    return _$fetchCharacterAsyncAction.run(() => super.fetchCharacter(id));
  }
